...
Then I got introduced to new templates, UI component libraries, and a few portfolio sites that were very clean and simply did the job. I consulted another friend, [Ahmed Shaikh](https://www.linkedin.com/in/ahmd-sh/); another experienced and senior dev.
...
It’s not a project. It’s merely an guide for what I can be.
...
Finally, after spending *less* time than before in search for inspiration, I decided to just fork [Dillon's portfolio](https://github.com/magicuidesign/portfolio) for my own peace of mind.

So I needed to act fast. With less time spent building it, I’m content with the outcome. Does having. portfolio same as Dillon’s make me lose points? No. Does it degrade my skill? No.
